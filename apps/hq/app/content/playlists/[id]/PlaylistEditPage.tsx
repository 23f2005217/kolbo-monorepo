          ...
          <div className="space-y-6">
            ...
            <Card className="border-border/60">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label>Authors</Label>
                  <p className="text-xs text-muted-foreground">You don't have any authors. <button className="text-blue-600 hover:underline">Add authors</button></p>
                </div>
                ...
                {formData.videos.map((v: any, i: any) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[10px] text-muted-foreground">Available for free</p>
                    </div>
                    <div className="flex items-center gap-4">
                       <Button variant="ghost" size="sm" className="text-xs text-muted-foreground">Drip</Button>
                       <Button 
                        variant="ghost" 
                        size="sm" 
                ...
                {formData.status === 'scheduled' && (
                  <div className="pt-2 space-y-2">
                    ...
                    <p className="text-[10px] text-muted-foreground">
                      This collection will be automatically published at the selected time.
                    </p>
                  </div>
                )}
                <button className="text-blue-600 text-xs font-semibold">+ Add expiration date</button>
              </CardContent>
            </Card>
                ...
                <RadioGroup value={formData.isFree ? "free" : "gated"} onValueChange={(val) => setFormData({ isFree: val === "free" })}>
                  ...
                  <div className="flex items-start space-x-2 mt-4">
                    ...
                    <div className="space-y-0.5">
                      ...
                      <p className="text-[10px] text-muted-foreground leading-relaxed">All users will be able to watch this collection, including users that are not logged in. Drip delay days will be reset for playlist videos.</p>
                    </div>
                  </div>
                </RadioGroup>
              </CardContent>
        ...
        onSelect={(selectedVideos: any[]) => {
          setFormData({
            videos: selectedVideos.map((v: any, i: any) => ({
              id: "", // Temporary or will be generated by backend
              videoId: v.id,
              title: v.title,
